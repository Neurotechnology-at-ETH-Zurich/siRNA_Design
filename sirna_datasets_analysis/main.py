...
from dataset_hall2006 import lowest, highest, lowest_overhang, highest_overhang
from datasetC_mysirna import antisense_below10_C_overhang, antisense_above90_C_overhang #  get them with overhang
from datasetD_mysirna import antisense_below10_D, antisense_above90_D
...
dataset1_column = 3
sheet.cell(1,dataset1_column).value = 'Dataset Hall'
# add subcolumns
startpos = 3
...
##################################################
print("Mysirna dataset C")

# add name of dataset to excel to C1, as well as the required columns
dataset1_column = 7
sheet.cell(1,dataset1_column).value = 'Dataset C (Mysirna)'
# add subcolumns
startpos = 7
excel_workbook, sheet = excel_addnewdataset(startpos, excel_workbook, sheet, 'sirna_datasets_results.xlsx')
...
##################################################
print("Mysirna dataset D")

# add name of dataset to excel to C1, as well as the required columns
dataset1_column = 11
sheet.cell(1,dataset1_column).value = 'Mysirna Dataset D'
# add subcolumns
startpos = 11
excel_workbook, sheet = excel_addnewdataset(startpos, excel_workbook, sheet, 'sirna_datasets_results.xlsx')
